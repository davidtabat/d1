...
class MDN_MarketPlace_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('marketplace_order_id', array(
            ...
            'index' => 'entity_id',
            'renderer' => 'MDN_MarketPlace_Block_Widget_Grid_Column_Renderer_Sales_Order_Grid_MarketPlaceOrderId',
            'filter' => 'MDN_MarketPlace_Block_Widget_Grid_Column_Filter_Sales_Order_Grid_MarketPlaceOrderId'
        ));
