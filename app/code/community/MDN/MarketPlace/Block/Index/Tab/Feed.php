 ...
 * @version 2.1
 */
class MDN_MarketPlace_Block_Index_Tab_Feed extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        //charge
        $collection = mage::getModel('MarketPlace/Feed')->getCollection()->addFieldToFilter('mp_country',Mage::registry('mp_country')->getId())->setOrder('mp_id', 'DESC');
