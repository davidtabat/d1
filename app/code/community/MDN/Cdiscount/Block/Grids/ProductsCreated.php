 ...
 * @version 2.0
 */
class MDN_Cdiscount_Block_Grids_ProductsCreated extends MDN_MarketPlace_Block_Products {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->setId('created_products_grid');
    ...
    protected function _getCondition() {
        return ($this->getCountry()->getId()) ? 'mp_marketplace_id="' . $this->getCountry()->getId() . '" AND mp_marketplace_status="created"' : '1';
    }
    ...
    /*public function getGridUrl() {
        return $this->getUrl('Cdiscount/Main/productsCreatedGridAjax', array('_current' => true, 'country_id' => $this->getCountry()->getId()));
    }*/
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('mp_last_update', array(
                'header' => Mage::Helper('MarketPlace')->__('Last sync'),
        ...
        /*$this->addColumn('mp_update_status', array(
            ...
            //'renderer' => 'MDN_MarketPlace_Block_Widget_Grid_Column_Renderer_UpdateStatus'
        ));*/
