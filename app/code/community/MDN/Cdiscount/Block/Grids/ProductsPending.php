 ...
 * @version 2
 */
class MDN_Cdiscount_Block_Grids_ProductsPending extends MDN_MarketPlace_Block_Products {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->setId('pending_products_grid');
    ...
    protected function _getCondition() {
        return ($this->getCountry()->getId()) ? 'mp_marketplace_id="' . $this->getCountry()->getId() . '" AND mp_marketplace_status IN ("pending", "incomplete")' : '1';
    }
    ...
    public function getGridUrl() {
        return $this->getUrl('Cdiscount/Main/productsPendingGridAjax', array('_current' => true, 'country_id' => $this->getCountry()->getId()));
    }
