...
class Mageshops_Rakuten_Block_Catalog_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
...
//        return $this->getProduct()->getCategoriesReadonly();
    ...
    {
        return $this->getUrl('*/*/syncCategories', array('_current' => true));
    }
}
