...
class IWD_OrderManager_Model_Cataloginventory_Stock extends Mage_CatalogInventory_Model_Stock
{
    ...
    protected function isMultiInventoryEnabled()
    {
        ...
        (
            in_array($module, array('IWD_OrderManager_Adminhtml', 'Mage_Adminhtml')) &&
            in_array($controller, array('catalog_product', 'cataloginventory_order', 'cataloginventory_stock', 'cataloginventory_product', 'sales_orderr', 'system_config'))
        );
    }
