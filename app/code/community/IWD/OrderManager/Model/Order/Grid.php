...
class IWD_OrderManager_Model_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function getSelectedColumnsArray($grid_xpath)
    {
        ...
        //Customer_groups
        array_unshift($selected_columns, 'customer_group_id');
    ...
    public function getOrdersCollection($selected_columns, $collection = null)
    {
        ...
        $sales_flat_order = array('shipping_description', 'customer_email', 'coupon_code', 'weight', 'customer_note', 'base_tax_amount', 'tax_amount', 'base_shipping_amount', 'shipping_amount', 'customer_group_id');
        ...
        //Customer group
        if (in_array('customer_group_id', $selected_columns) && empty(array_intersect($selected_columns, $sales_flat_order))) {
            $collection->getSelect()->joinLeft($tableName_sales_flat_order,
                "main_table.entity_id = {$tableName_sales_flat_order}.entity_id",
