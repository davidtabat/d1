...
class Mirasvit_Rma_Helper_MailTest extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function parseVariablesProvider()
    {
        return array(
            ...
            array('http://example.com/returns/guest/view/id/abcdef12345/', '{{var rma.guest_url}}'),
            array('http://example.com/returns/guest/print/id/abcdef12345/', '{{var rma.guest_print_url}}'),
            array(
"PRODUCT NAME
SKU
QTY
