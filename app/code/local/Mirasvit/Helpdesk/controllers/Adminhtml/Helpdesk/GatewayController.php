...
class Mirasvit_Helpdesk_Adminhtml_Helpdesk_GatewayController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $link = Mage::helper('helpdesk/help')->getManualLink('known_issues/gateway_connection');

                $message .= " <a href='$link' target='_blank'>more info..</a>";
