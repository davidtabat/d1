...
class FME_Shipment_Block_Adminhtml_Sales_Shipment_Grid extends Mage_Adminhtml_Block_Sales_Shipment_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('product_images', array(
            'header'    => Mage::helper('sales')->__('Product Images'),
            'index'     => 'order_increment_id',
            'renderer' => 'FME_Shipment_Block_Adminhtml_Sales_Shipment_Grid_Images',
            'filter'    => false,
        ));
        ...
        $this->addColumn('shipping_address', array(
            ...
            'index' => 'order_increment_id',
            'renderer' => 'FME_Shipment_Block_Adminhtml_Sales_Shipment_Grid_Address',
            'filter'    => false,
        ));
