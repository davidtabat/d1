    ...
    public function __construct()
    {
        ...
        if (Mage::registry('pickup_data') && Mage::registry('pickup_data')->getId()) {
            ...
            function cancelPickup(){
                ...
                if(conf==true){
                    window.location.assign('" . Mage::helper("adminhtml")->getUrl("adminhtml/upslabel_pickup/cancel/id/" . Mage::registry('pickup_data')->getId()) . "');
                }
            }
        ";
        }
        if (Mage::registry('pickup_data') && Mage::registry('pickup_data')->getId()) {
            ...
            function statusPickup(){
                window.location.assign('" . Mage::helper("adminhtml")->getUrl("adminhtml/upslabel_pickup/status/id/" . Mage::registry('pickup_data')->getId()) . "');
            }
        ";
        }
    }
