...
class Infomodus_Upslabel_Adminhtml_PickupController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->_addContent($this->getLayout()->createBlock('adminhtml/upslabel_pickup_edit'))
                ->_addLeft($this->getLayout()->createBlock('adminhtml/upslabel_pickup_edit_tabs'));
    ...
    {
        $fileName = 'pickup.csv';
        $content = $this->getLayout()->createBlock('adminhtml/upslabel_pickup_grid')
            ->getCsv();
