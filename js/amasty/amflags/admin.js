...
function setOrderFlag(setFlagUrl, orderId, flagId, columnId, emptyUrl)
{
    if (flagId)
    {
        ...
        title=$('flagselect-comment-' + orderId + '-column-' + columnId + '-' + flagId).title;
        ...
        postData = 'form_key=' + FORM_KEY + '&orderId=' + orderId + '&flagId=' + flagId + '&columnId='+ columnId + '&comment=' + comment+ '&title=' + title;
