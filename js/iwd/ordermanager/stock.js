...
IWD.OrderManager.Stock = {
    ...
    init: function()
    {
        ...
        $ji(document).on('hidden.bs.modal', '#iwd_om_popup' ,function () {
        ...
        $ji('#iwd_om_popup').on('hide.bs.modal', function () {
    ...
    showAssignStockForm: function(orderId)
    {
        ...
        this.postRequest(data, this.iwdAssignStockFormUrl, function(result){
            $ji('#iwd_om_popup_form').html(result.form);
    ...
    showPopup:function()
    {
        ...
        $ji('#iwd-om-popup-box .om-iwd-modal-content').attr('class','om-iwd-modal-content')
            .addClass("warehouses-" + $ji('#iwd_om_popup .assign-stock-table').attr('data-warehouses'));
    },
...
IWD.OrderManager.Stock.Order = {
    ...
    {
        $ji('#iwd_om_popup_form').html(form);
